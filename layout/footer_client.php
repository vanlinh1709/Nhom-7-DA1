                ...
                <div class="col-lg-6 col-sm-12">
                    <div class="address-block mt-30">
                        ...
                        <address class="address-info d-flex align-items-center">
                            ...
                            <p><span>ĐỊA CHỈ :  </span><?php echo $infoShop['address']?></p>
                        </address>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <address class="address-info email mt-30">
                        ...
                        <p><span>EMAIL : </span><a href="emailto:demo@examplecom"><?php echo $infoShop['email']?></a></p>
                    </address>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <address class="address-info email mt-30">
                        <i class="fa fa-phone"></i>
                        <p><span>ĐIỆN THOẠI : </span><a href="tel:0123456789"><?php echo $infoShop['phone']?></a></p>
                    </address>
                </div>
            </div>
        </div>
